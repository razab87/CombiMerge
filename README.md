...
CombiMerge is a python plugin for GIMP 3.x (requires python3). When you have a GIMP session with several grouped layers, CombiMerge selects one layer from each group, merges them together and exports the result as image. This is done for every possible combination. For a detailed description of how it works, see the "Usage" section below.
...
- Extract the .zip-file and copy the folder "combi_merge" found in CombiMerge-1-0/ to your .../GIMP/3.x/plug-ins folder.
